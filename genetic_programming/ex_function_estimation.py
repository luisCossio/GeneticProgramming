...
def main(args):
    ...
    results = best.root_node.get_result_operation_node()
    n_nodes = [population.population[i].root_node.get_value() for i in range(len(population.population))]
    max_node = max(n_nodes)
...
args = Namespace(population=50,  # 5, 15 50
                 ...
                 output = [-3.5, 0.0, 5.5, 13.0, 22.5, 34.0, 47.5],
